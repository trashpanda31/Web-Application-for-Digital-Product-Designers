    ...
    <div className="bg-[#f7faff] flex flex-row justify-center w-full min-h-screen">
      <div className="bg-[#f7faff] overflow-hidden w-[1440px] min-h-screen relative">
        ...
        <div className="absolute w-[1280px] h-56 top-[185px] left-20">
          <p
            className="absolute w-[533px] top-[-22px] left-[373px] [font-family:'Gilroy-SemiBold',Helvetica] font-normal text-black text-[40px] text-center tracking-[0] leading-[normal]">
            Discover high-quality visuals for every creative need
          </p>

          <p
            className="absolute w-[486px] top-[111px] left-[397px] [font-family:'Gilroy-Regular',Helvetica] font-normal text-black text-base text-center tracking-[0] leading-[normal]">
            ...
            {isImageSearchActive && imageFileName && (
              <div
                ...
                <span className="truncate max-w-[60px]"
                      style={{ fontFamily: 'inherit', fontSize: '13px' }}>{imageFileName}</span>
                <img
          ...
          <div onClick={toggleFilters}
            ...
            <div
              className="absolute w-[50px] top-3 left-[17px] [font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-sm tracking-[0] leading-[normal] whitespace-nowrap">
              Filters
            </div>
        ...
        <div className={`mt-[440px] px-20 transition-all duration-300 ease-in-out`}>
          ...
          <div className="grid grid-cols-4 gap-x-6 gap-y-6">
            {(isImageSearchActive ? imageSearchResults : posts).map((post, idx, arr) => {
              if (arr.length === idx + 1 && !isImageSearchActive) {
                return (
                  <Link to={`/image-card-logged/${post && post._id ? post._id : ''}`}
                        key={post && post._id ? post._id : `empty-${idx}`} ref={lastPostRef}>
                    <div className="w-[302px] h-[286px]">
                      <div
                        className="relative w-[302px] h-[260px] bg-[#d9d9d9] rounded-[18px] overflow-hidden flex items-center justify-center group">
                        {post && post.imageUrl && (
                          <>
                            ...
                            <div
                              ...
                              <div
                                className="w-full p-3 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                      ...
                      <div className="h-[22px] mt-4 flex items-center">
                        {post ? (
                          <>
                            ...
                            <span
                              className="ml-2 [font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-xs">
                          ...
                          <>
                            ...
                            <span
                              className="ml-2 [font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-xs">Username</span>
                            <img className="ml-auto w-[18px] h-[18px]" alt="Like" src="/img/like-15.svg" />
                            <span
                              className="ml-2 [font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-xs">0</span>
                          </>
                        )}
                      </div>
                    </div>
                ...
                return (
                  <Link to={`/image-card-logged/${post && post._id ? post._id : ''}`}
                        key={post && post._id ? post._id : `empty-${idx}`}>
                    <div className="w-[302px] h-[286px]">
                      <div
                        className="relative w-[302px] h-[260px] bg-[#d9d9d9] rounded-[18px] overflow-hidden flex items-center justify-center group">
                        {post && post.imageUrl && (
          ...
          {isImageSearchActive && !imageSearchLoading && imageSearchResults.length === 0 &&
            <div className="text-center py-8">No results found</div>}
          {loading && <div className="text-center py-8">Loading...</div>}
          {!loading && !isImageSearchActive && posts.length === 0 &&
        ...
        <footer className="w-full flex flex-col items-center mt-20 mb-8">
          ...
          <div
            className="[font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-xl tracking-[0] leading-[normal] whitespace-nowrap mb-2">
            All rights recovered
          </div>
          <div
            className="[font-family:'Gilroy-Medium',Helvetica] font-normal text-black text-xl tracking-[0] leading-[normal] whitespace-nowrap">
            © 2025 DesignBase
          </div>
        </footer>
