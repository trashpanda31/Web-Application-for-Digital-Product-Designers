  ...
  return (
    <div className="bg-[#f7faff] min-h-screen flex flex-row justify-center w-full">
      <div className="bg-[#f7faff] w-[1440px] h-[705px] relative">
        ...
        <div className="absolute top-[145px] left-[603px] [font-family:'Gilroy-SemiBold',Helvetica] font-normal text-black text-2xl text-center tracking-[0] leading-[normal]">
